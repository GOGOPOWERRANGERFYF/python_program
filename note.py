...
#   请求格式(报文):
#       请求首行: 方法(get/post) URI(统一资源标识符/xxx/xx) 协议版本(HTTP/1.1)       
#       请求头:请求首部字段
#       内容实体
#   请求首行/r/n请求头/r/n请求头/r/n/r/n请求体(报文本质:字节串,当然,字节串和字符串之间可以转换)
#
#   报文预览(文本):
#       请求首行
#       请求头
...
#        请求首行:(方法GET)(URl?提交的数据参数&参数)(协议版本HTTP/1.1)/r/n请求头/r/n请求头/r/n/r/n请求体
